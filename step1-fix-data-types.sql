-- STEP 1: FIX DATA TYPES AND ADD MISSING COLUMNS
-- This addresses the COALESCE type mismatch error
...
SET 
    ...
    skills = COALESCE(skills, '["Teaching"]'::jsonb),
...
SET 
    ...
    facilities = COALESCE(facilities, '["Classrooms", "Library"]'::jsonb),
