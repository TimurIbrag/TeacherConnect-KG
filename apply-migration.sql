-- Apply this migration directly in your Supabase Dashboard SQL Editor
-- This will add all the missing fields to the profiles table for admin editing

-- Step 1: Add teacher-specific fields
...
-- Step 2: Add school-specific fields
ALTER TABLE public.profiles 
...
-- Step 3: Add admin functionality fields
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE;

-- Step 4: Update existing profiles to have is_active = true
UPDATE public.profiles SET is_active = TRUE WHERE is_active IS NULL;

-- Step 5: Create function to update profile completeness
...
-- Step 6: Create trigger for profile completeness
...
-- Step 8: Add policy for admin to view all profiles
